  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="px-6 pt-12 pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Today Overview */}
          <div className="border-l-2 border-muted pl-4 py-2 mb-6">
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-4 text-xs">
                <span className="text-muted-foreground">{meetings.length} meetings</span>
                <span className="text-primary">{upcomingCount} upcoming</span>
                <span className="text-destructive">{debriefCount} need debrief</span>
              </div>
            </div>
          </div>
        </div>
