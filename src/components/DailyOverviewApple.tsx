        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {nextHCPData && <div className="bg-gradient-to-br from-primary/5 to-accent/5 border border-primary/20 rounded-2xl p-6 shadow-lg relative overflow-hidden">
              ...
              <div className="relative mb-6">
                ...
                <div className="flex items-center gap-4 mt-4">
                  <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                    nextHCPData.accessLevel === "High" ? "bg-green-100 text-green-700" : 
                    nextHCPData.accessLevel === "Medium" ? "bg-yellow-100 text-yellow-700" : 
                    "bg-red-100 text-red-700"
                  }`}>
                    {nextHCPData.accessLevel} Access
                  </div>
                  <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                    nextHCPData.consentStatus === "OPT IN" ? "bg-green-100 text-green-700" : 
                    nextHCPData.consentStatus === "OPT OUT" ? "bg-red-100 text-red-700" : 
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  {nextHCPData.importantPoints.map((point, index) => (
                    <div key={index} className="flex items-start gap-3 p-4 bg-white/50 border border-white/60 rounded-xl backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="flex items-center justify-between p-4 bg-white/40 border border-white/60 rounded-xl backdrop-blur-sm">
                  <div className="flex items-center gap-3">
                    <div className={`w-3 h-3 rounded-full ${
                      nextHCPData.segmentationStatus === "At risk" ? "bg-red-400" : 
                      nextHCPData.segmentationStatus === "Growing" ? "bg-green-400" : 
                      "bg-yellow-400"
                    }`} />
                    <span className="font-medium text-foreground">Relationship Status</span>
                  </div>
                  <span className={`font-semibold ${
                    nextHCPData.segmentationStatus === "At risk" ? "text-red-600" : 
                    nextHCPData.segmentationStatus === "Growing" ? "text-green-600" : 
                    "text-yellow-600"
                  }`}>
                ...
                {nextHCPData.consentStatus === "OPT OUT" && (
